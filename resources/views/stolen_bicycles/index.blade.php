<x-app-layout>
    ...
    <a href="{{ route('abd.create') }}">
        放置されている自転車を発見された方（放置自転車情報登録）<br>※ログインが必要です．<br><br>
    </a>
    ...
    <div class='slnbikes'>
        ...
        <a href="{{ route('sln.show', $slnbike) }}">
            <div class="slnbike">
                ...
                <img src="{{ empty($slnbike->image_path) ? asset('images/no-image.png') : $slnbike->image_path }}" alt="プレビュー画像" style="max-width: 200px; height: auto;">
