<x-app-layout>
    ...
    <form action="{{ route('abd.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <input list="manufacturer_list" name="abandonedbicycle[manufacturer]" id="manufacturer" value="{{ old('abandonedbicycle.manufacturer') }}">
        ...
        <div class="model_name">
            ...
            <input type="text" name="abandonedbicycle[model_name]" id="model_name" value="{{ old('abandonedbicycle.model_name') }}">
            <p style="color: red; font-size: 0.9rem;">{{ $errors->first('abandonedbicycle.model_name') }}</p>
        </div>

        <div class="frame_num">
            <label for="frame_num">車体番号</label>
            <input type="text" name="abandonedbicycle[frame_num]" id="frame_num" value="{{ old('abandonedbicycle.frame_num') }}">
            <p style="color: red; font-size: 0.9rem;">{{ $errors->first('abandonedbicycle.frame_num') }}</p>
        </div>

        <div class="color">
            <label for="color">色</label>
            <input type="text" name="abandonedbicycle[color]" id="color" value="{{ old('abandonedbicycle.color') }}">
        ...
        <div class="bouhan_num">
            ...
            <input type="text" name="abandonedbicycle[bouhan_num]" id="bouhan_num" value="{{ old('abandonedbicycle.bouhan_num') }}">
            <p style="color: red; font-size: 0.9rem;">{{ $errors->first('abandonedbicycle.bouhan_num') }}</p>
        </div>

        <div class="found_at">
            <label for="found_at">発見日時</label>
            <input type="datetime-local" name="abandonedbicycle[found_at]" id="found_at" value="{{ old('abandonedbicycle.found_at') }}" min="2000-01-01T00:00" max="2099-12-31T23:59">
        ...
        <div class="found_location">
            ...
            <input type="text" name="abandonedbicycle[found_location]" id="found_location" value="{{ old('abandonedbicycle.found_location') }}">
            <p style="color: red; font-size: 0.9rem;">{{ $errors->first('abandonedbicycle.found_location') }}</p>
        </div>

        <div class="features">
            <label for="features">車体特徴</label>
            <textarea name="abandonedbicycle[features]" id="features">{{ old('abandonedbicycle.features') }}</textarea>
            <p style="color: red; font-size: 0.9rem;">{{ $errors->first('abandonedbicycle.features') }}</p>
        </div>

        <div class="other">
            <label for="other">その他</label>
            <textarea name="abandonedbicycle[other]" id="other">{{ old('abandonedbicycle.other') }}</textarea>
    ...
    <div class="footer">
        <a href="{{ route('abd.index') }}">登録をやめる</a>
    </div>
