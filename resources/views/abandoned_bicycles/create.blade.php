    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <form action="{{ route('abd.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="model">
                                ...
                                <select name="abandonedbicycle[model]" id="model" class="mt-1 block w-full rounded border-gray-300 shadow-sm">
                                    <option value="">-- 選択してください --</option>
                                    @foreach ($models as $model)
                                    <option value="{{ $model }}" {{ old('abandonedbicycle.model') === $model ? 'selected' : '' }}>
                                        {{ $model }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="manufacturer">
                                ...
                                <input list="manufacturer_list" name="abandonedbicycle[manufacturer]" id="manufacturer" placeholder="メーカー名を選択または入力" value="{{ old('abandonedbicycle.manufacturer') }}" class="mt-1 block w-full rounded border-gray-300 shadow-sm">
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="model_name">
                                ...
                                <input type="text" name="abandonedbicycle[model_name]" id="model_name" value="{{ old('abandonedbicycle.model_name') }}" class="mt-1 block w-full rounded border-gray-300 shadow-sm">
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="frame_num">
                                ...
                                <input type="text" name="abandonedbicycle[frame_num]" id="frame_num" value="{{ old('abandonedbicycle.frame_num') }}" class="mt-1 block w-full rounded border-gray-300 shadow-sm">
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="color">
                                ...
                                <input type="text" name="abandonedbicycle[color]" id="color" value="{{ old('abandonedbicycle.color') }}" class="mt-1 block w-full rounded border-gray-300 shadow-sm">
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="bouhan_num">
                                ...
                                <div class="flex gap-4">
                                    <!-- 都道府県選択 -->
                                    <div class="flex-1">
                                        <select name="abandonedbicycle[prefecture]" id="prefecture" class="mt-1 block w-full rounded border-gray-300 shadow-sm">
                                            <option value="">-- 選択してください --</option>
                                            @foreach ($prefectures as $key => $value)
                                            <option value="{{ $key }}" {{ old('abandonedbicycle.prefecture') === $key ? 'selected' : '' }}>
                                                {{ $key }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <!-- 防犯登録番号入力欄 -->
                                    <div class="flex-1">
                                        <input type="text" name="abandonedbicycle[bouhan_num]" id="bouhan_num" value="{{ old('abandonedbicycle.bouhan_num') }}" class="mt-1 block w-full rounded border-gray-300 shadow-sm">
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="found_at">
                                ...
                                <input type="datetime-local" name="abandonedbicycle[found_at]" id="found_at" value="{{ old('abandonedbicycle.found_at') }}" min="2000-01-01T00:00" max="2099-12-31T23:59" class="mt-1 block w-full rounded border-gray-300 shadow-sm">
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="found_location">
                                ...
                                <input type="text" name="abandonedbicycle[found_location]" id="found_location" value="{{ old('abandonedbicycle.found_location') }}" class="mt-1 block w-full rounded border-gray-300 shadow-sm">
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="features">
                                ...
                                <textarea name="abandonedbicycle[features]" id="features" rows="4" class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:outline-none">{{ old('abandonedbicycle.features') }}</textarea>
                        ...
                        <div class="bg-white p-6 rounded shadow sm:rounded-lg">
                            <div class="other">
                                ...
                                <textarea name="abandonedbicycle[other]" id="other" rows="4" class="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:outline-none">{{ old('abandonedbicycle.other') }}</textarea>
